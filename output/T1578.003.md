...
[[ detecting a sequence of events such as the creation of an instance]]

[[ mounting of a snapshot to that instance]]

[[ and deletion of that instance by a new user account may indicate suspicious activity.

In AWS]]

[[ CloudTrail logs capture the deletion of an instance in the <code>TerminateInstances</code> event]]
