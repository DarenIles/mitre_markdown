...
Link: [T1070.003 - Indicator Removal: Clear Command History](https://attack.mitre.org/techniques/T1070/003)
...
[[ especially via remote terminal services like SSH]]

[[ without new entries in that user's <code>~/.bash_history</code> is suspicious. Additionally]]

[[ the removal/clearing of the <code>~/.bash_history</code> file can be an indicator of suspicious activity.
