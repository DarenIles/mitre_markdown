...
Link: [T1082 - System Information Discovery](https://attack.mitre.org/techniques/T1082)
...
[[ native logging can be used to identify access to certain APIs and dashboards that may contain system information. Depending on how the environment is used]]

[[ that data alone may not be useful due to benign use during normal operations.]]
