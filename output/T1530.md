...
Link: [T1530 - Data from Cloud Storage](https://attack.mitre.org/techniques/T1530)
...
[[Monitor for unusual queries to the cloud provider's storage service. Activity originating from unexpected sources may indicate improper permissions are set that is allowing access to data. Additionally]]

[[ detecting failed attempts by a user for a certain object]]

[[ followed by escalation of privileges by the same user]]

[[ and access to the same object may be an indication of suspicious activity.]]
