...
[[Monitor network traffic for unusual ARP traffic]]

[[ gratuitous ARP replies may be suspicious. 

Consider collecting changes to ARP caches across endpoints for signs of ARP poisoning. For example]]

[[ if multiple IP addresses map to a single MAC address]]

[[ this could be an indicator that the ARP cache has been poisoned.]]
