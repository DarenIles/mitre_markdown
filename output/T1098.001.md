...
[[Monitor Azure Activity Logs for Service Principal and Application modifications. Monitor for the usage of APIs that create or import SSH keys]]

[[ particularly by unexpected users or accounts such as the root account.
